...
def test_add_new_pet_valid_data(name="Мышка", animal_type="мышь полевая", age="5", pet_photo="images/mouse.jpg"):
...
def test_delete_pet():
    ...
    if len(my_pets["pets"]) == 0:
        pf.add_new_pet(auth_key, "Барсик", "сибирская", "7", "images/cat.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_update_pet_info(name="Мышка", animal_type="Мышь", age="5"):
...
def test_add_new_pet_without_photo_valid_data(name="Рекс", animal_type="Овчарка", age="5"):
...
def test_set_photo_pet(pet_photo="images/Rex.jpg"):
...
def test_add_new_pet_incorrect_age(name="Хомяк", animal_type="мышь", age="-1", pet_photo="images/mouse.jpg"):
    """ Проверяем возможность добавить питомца с отрицательным возрастом (не добавляется)"""
...
def test_delete_not_your_pet():
    """ Проверяем возможность удаления не своего питомца (удаляется) """
...
def test_update_not_your_pet_info(name="Билли", animal_type="мышь", age="5"):
    """ Проверяем возможность обновления информации не о своем питомце (обновляется) """
...
def test_add_new_pet_without_photo_empty_data(name="", animal_type="", age=""):
    """ Проверяем возможность добавления питомца (без фото) с незаполненными данными (добавляется) """
...
def test_set_photo_not_your_pet(pet_photo="images/Rex.jpg"):
